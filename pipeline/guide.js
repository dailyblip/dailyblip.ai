...
STYLE: flat vector-style illustration \u2014 like a polished, professionally designed PowerPoint or Keynote slide graphic, or a modern infographic. Crisp geometric shapes with clean, even edges. Precise alignment and consistent, even spacing between elements \u2014 nothing crowded, nothing off-center, nothing at an awkward or random scale relative to the rest of the composition. Flat color fills, not painterly texture, not photorealistic rendering, not a gritty or hand-drawn look. Simple, consistent iconography rather than detailed illustration. Should look like it came out of a real design tool, not "generated" \u2014 the test is whether it would look at home in an actual professional slide deck or a designed infographic, not whether it looks impressive as standalone AI art. Should be able to stand alone on social media as well as inside the article.
...
AVOID across every image: random floating interfaces, generic futuristic aesthetics, people staring at screens unless essential to the concept, random robots, glowing AI brains, holograms, watermarks, celebrity likenesses, copyrighted characters, unapproved company logos, fabricated product screenshots, near-duplicate compositions across the set, painterly or textured rendering, hand-drawn or sketchy linework, uneven or off-center spacing between elements, text or labels crowded against each other or against the frame edge. Any text inside the image should be minimal per the hard limit above, and never the article headline. Leave negative space where HTML text may be placed afterward, and keep that negative space clear of any element that would otherwise get clipped by it.
